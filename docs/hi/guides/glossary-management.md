...
**v1.2 में नया: अंग्रेजी उपनाम**

MQM शब्दकोश अब अंग्रेजी और मूल भाषा दोनों त्रुटि प्रकारों को स्वीकार करते हैं। यह सत्यापन विफलताओं को रोकता है जब LLM अंग्रेजी प्रकार जैसे `inconsistency`, `formatting` या `untranslated` लौटाता है।

### IT शब्दावली शब्दकोश (v1.2 में नया)

**उपलब्ध भाषाओं में:** अंग्रेजी, रूसी, चीनी, हिंदी, फारसी

तकनीकी दस्तावेज़ीकरण के लिए व्यापक IT और सॉफ्टवेयर विकास शब्दावली:

| भाषा | फ़ाइल | शब्द |
|------|-------|------|
| अंग्रेजी | `glossaries/en/it_terminology_en.json` | 200 |
| रूसी | `glossaries/ru/it_terminology_ru.json` | 150 |
| चीनी | `glossaries/zh/it_terminology_zh.json` | 120 |
| हिंदी | `glossaries/hi/it_terminology_hi.json` | 100 |
| फारसी | `glossaries/fa/it_terminology_fa.json` | 100 |

**कवर की गई श्रेणियां:**
- CLI और shell (bash, zsh, stdin, stdout, pipe)
- संस्करण नियंत्रण (git, commit, branch, merge, PR)
- विकास प्रक्रिया (Agile, sprint, deploy, CI/CD)
- आर्किटेक्चर (microservice, container, Kubernetes)
- क्लाउड इंफ्रास्ट्रक्चर (AWS, Azure, GCP, IaaS)
- डेटा और स्टोरेज (SQL, NoSQL, Redis, ORM)
- API और एकीकरण (REST, GraphQL, OAuth, JWT)
- परीक्षण (unit test, mock, TDD, coverage)
