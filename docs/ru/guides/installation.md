...
Это установит основные зависимости (~50МБ):
- Интерфейс командной строки
- Многоагентная система контроля качества
...
**Требования:**
- Java 17.0 или выше
- ~200МБ дискового пространства

Функции:
- 5000+ грамматических правил
...
- ~300МБ загрузка модели при первом использовании
