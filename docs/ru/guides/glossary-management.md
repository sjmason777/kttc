...
**НОВОЕ в v1.2: Английские алиасы**

Глоссарии MQM теперь принимают как английские, так и нативные типы ошибок. Это предотвращает ошибки валидации, когда LLM возвращает английские типы вроде `inconsistency`, `formatting` или `untranslated` для неанглийских языковых пар.

### Глоссарии IT-терминологии (НОВОЕ в v1.2)

**Доступно на:** Английский, Русский, Китайский, Хинди, Персидский

Комплексная IT и программистская терминология для технической документации:

| Язык | Файл | Терминов |
|------|------|----------|
| Английский | `glossaries/en/it_terminology_en.json` | 200 |
| Русский | `glossaries/ru/it_terminology_ru.json` | 150 |
| Китайский | `glossaries/zh/it_terminology_zh.json` | 120 |
| Хинди | `glossaries/hi/it_terminology_hi.json` | 100 |
| Персидский | `glossaries/fa/it_terminology_fa.json` | 100 |

**Покрываемые категории:**
- CLI и shell (bash, zsh, stdin, stdout, pipe)
- Контроль версий (git, commit, branch, merge, PR)
- Процесс разработки (Agile, sprint, deploy, CI/CD)
- Архитектура (microservice, container, Kubernetes)
- Облачная инфраструктура (AWS, Azure, GCP, IaaS)
- Данные и хранение (SQL, NoSQL, Redis, ORM)
- API и интеграция (REST, GraphQL, OAuth, JWT)
- Тестирование (unit test, mock, TDD, coverage)
...
**НОВОЕ в v1.2: Белый список IT-терминологии (123 термина)**

Интеграция LanguageTool теперь включает белый список IT-терминологии, который предотвращает ложные срабатывания для распространённых программистских терминов:

| Предложение LanguageTool | Фактический термин | Категория |
|-------------------------|-------------------|-----------|
| «Бисмарк» | бенчмарк | Тестирование |
| «волкеров» | воркеров | Параллелизм |
| «заколотить» | закоммитить | Git |
| «Демокритам» | демо-режим | Интерфейс |

Термины в белом списке: бенчмарк, воркер, деплой, докер, кубернетес, коммит, фикс, хотфикс, рефактор, дебаг, логгер, прод, стейджинг, мерж, ребейз, чекаут, пуш, пулл, фетч и ещё 100+ терминов.
...
│   └── it_terminology_en.json   # IT-терминология (200 терминов) [НОВОЕ v1.2]
├── ru/
│   ├── mqm_core_ru.json         # Русские определения MQM (с английскими алиасами)
│   ├── grammar_reference.json   # Правила русской грамматики
│   └── it_terminology_ru.json   # IT-терминология (150 терминов) [НОВОЕ v1.2]
├── zh/
│   ├── mqm_core_zh.json         # Китайские определения MQM (с английскими алиасами)
│   ├── classifiers.json         # Китайские счетные слова
│   └── it_terminology_zh.json   # IT-терминология (120 терминов) [НОВОЕ v1.2]
├── hi/
│   ├── mqm_core_hi.json         # Определения MQM на хинди (с английскими алиасами)
│   ├── grammar_reference.json   # Правила грамматики хинди
│   └── it_terminology_hi.json   # IT-терминология (100 терминов) [НОВОЕ v1.2]
└── fa/
    ├── mqm_core_fa.json         # Персидские определения MQM (с английскими алиасами)
    ├── grammar_reference.json   # Правила персидской грамматики
    └── it_terminology_fa.json   # IT-терминология (100 терминов) [НОВОЕ v1.2]
```
